...
using System.Linq;
using EFLocalizationSample.Model;
...
namespace EFLocalizationSample
{
    public class EFStringLocalizer<T> : IStringLocalizer<T>
    {
        ...
        {
            return _db.Resources.Include(r => r.Culture).Where(r => r.Culture.Name == CultureInfo.CurrentCulture.Name).FirstOrDefault(r => r.Key == name)?.Value;
        }
    }
}

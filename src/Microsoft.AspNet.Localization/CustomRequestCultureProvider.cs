...
namespace Microsoft.AspNet.Localization
{
    ...
    {
        private readonly Func<HttpContext, Task<ProviderResultCulture>> _provider;
        ...
        public CustomRequestCultureProvider(Func<HttpContext, Task<ProviderResultCulture>> provider)
        {
            if (provider == null)
            {
